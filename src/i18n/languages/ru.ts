...
export const ru: Translation = {
	...
	// Commits 更新记录
	[Key.commits]: "Коммиты",
	[Key.commitsDescription]: "Просмотр последних коммитов и истории обновлений",
	[Key.commitsLoading]: "Загрузка коммитов...",
	[Key.commitsFailed]: "Не удалось загрузить коммиты",
	[Key.commitsViewOnGitHub]: "Посмотреть на GitHub",
};
